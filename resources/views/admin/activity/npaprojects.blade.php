    ...
    <table id="table_id" class="display">
        ...
        @foreach($npaprojects as $item)
            <tr>
                ...
                <td>{{ $item->files }}</td>
                <td>
                    <a href="{{ url('admin/projectnpa/?post_id='.$item->id.'#editModal') }}"><i class="fas fa-edit"></i></a>
                    <a href="{{ url('admin/remove/activities/'.$item->id.'/1') }}"><i class="fas fa-trash-alt" style="color:Red;"></i></a>
                </td>
            </tr>
        @endforeach
