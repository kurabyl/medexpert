    ...
    <table id="table_id" class="display">
        ...
        @foreach($statics as $item)
            <tr>
                ...
                <td>{{ $item->files }}</td>
                <td>
                    <a href="{{ url('admin/statics/?post_id='.$item->id.'#editModal') }}"><i class="fas fa-edit"></i></a>
                    <a href="{{ url('admin/remove/activities/'.$item->id.'/3') }}"><i class="fas fa-trash-alt" style="color:Red;"></i></a>
                </td>
            </tr>
        @endforeach
